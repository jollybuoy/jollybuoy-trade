      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2 border-t border-border-subtle pt-4">
          ...
          <button
            type="button"
            onClick={onCreate}
            className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-surface transition-colors hover:bg-accent-muted sm:flex-none"
          >
